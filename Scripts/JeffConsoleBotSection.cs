...
public class JeffConsoleBotSection
{
    ...
    public JeffConsoleBotSection()
    {
        _data = JeffConsoleData.Instance;
        _warpTex = AssetDatabase.LoadAssetAtPath(JeffConsole.ASSETS_PATH + JeffConsole.SPRITES_DIR + "/warp.png", typeof(Texture2D)) as Texture2D;
    }
